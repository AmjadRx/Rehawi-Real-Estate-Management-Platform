...
import { formatPayback, type PropertyFinancials } from "@/lib/finance";
...
export function DashboardView({
  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-6 px-4 py-6 md:px-8 md:py-8">
      <FadeIn>
        <h1 className="text-2xl md:text-3xl">Family portfolio</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          {propertyCount} properties · {statusCounts.completed} completed ·{" "}
          {statusCounts.under_construction} under construction ·{" "}
      ...
      <Stagger className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        ...
        <StaggerItem>
          <StatCard
            ...
            format={money}
            caption={`Estimated full return: ${formatPayback(totals.paybackMonths)}`}
          />
        </StaggerItem>
        <StaggerItem>
          <StatCard
            ...
            caption={`${formatMoney(totals.annualRunRate, baseCurrency)} / year`}
          />
        </StaggerItem>
        <StaggerItem>
          <StatCard
      ...
      <div className="grid gap-4 lg:grid-cols-5">
        ...
        >
          ...
          <p className="mb-4 text-sm text-muted-foreground">
            Last 12 months, family share, in {baseCurrency}
          </p>
